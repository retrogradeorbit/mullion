...
(def config-dir ".mullion")

(def loader-properties (Loader/loadProperties))

(defn get-property [property]
  (.getProperty ^java.util.Properties loader-properties property))
  ...
  [
   ...
   {:path "org/bytedeco/qt/"
    ...
    (cond
      ...
      macos?
      [
       "Qt5DBus@.5" "Qt5Gui@.5" "Qt5Widgets@.5" "Qt5PrintSupport@.5" "Qt5Core@.5"
       "jniQt5Core" "jniQt5Widgets" "qcocoa" "cocoaprintersupport" "qxdgdesktopportal"
       "qminimal" "qoffscreen" "qgif" "qico" "qjpeg" "jniQt5Gui"]
